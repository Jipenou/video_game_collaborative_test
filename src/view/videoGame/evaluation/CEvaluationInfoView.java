...
public class CEvaluationInfoView extends JFrame{
    ...
    public CEvaluationInfoView(CEvaluationController evaluationController, CEvaluation evaluation) {
        ...
        JButton gameButton = new JButton("Jeu vidéo : " + evaluation.getVideoGame().getName());
        panel.add(gameButton);
        gameButton.addActionListener(e -> evaluationController.getController().getVideoGameController().viewInfoGameFrame(evaluation.getVideoGame()));
